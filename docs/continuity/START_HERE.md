...
- Planned changes: upgrade the graphics card, upgrade the motherboard, and move compatible components into a portable case.
- Roger recalls the motherboard as the additional intended upgrade; its exact model remains recovery-required.
...
- Exact next product action: recover or confirm the graphics-card, motherboard, and portable-case models, then verify donor-system compatibility before purchasing.
...
- `rowdy-room/current-state`: v27, `eaa19365ebca76d98544621bd0627b6a8e7632111b4d3bb7d4a8b7967fe40c79`, history 108
...
- donor equipment key `main-production-pc-ryzen-5700x`
...
- exact portable-case model and transport requirements
- donor-system PSU, cooling, dimensions, connectors, drive layout, and internal clearances
...
PR #28 remains draft and unmerged until separately reviewed or merged. No production show system, purchase/cart, or Scheduled Task change is authorized by this record.
